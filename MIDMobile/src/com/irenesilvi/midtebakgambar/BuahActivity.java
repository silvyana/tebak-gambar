...
public class BuahActivity extends Activity {
	EditText jawabanTxt;
    ...
    public void cekJawaban(View v){
		String  jawabanBenar = "BUAH BIBIR";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),HidupActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.buah, menu);
		return true;
	}

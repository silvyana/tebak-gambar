...
public class BiasaActivity extends Activity {
	EditText jawabanTxt;
    ...
    public void cekJawaban(View v){
		String  jawabanBenar = "BIASA PUSING";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),BuahActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.biasa, menu);
		return true;
	}

...
public class AnjingActivity extends Activity {
	EditText jawabanTxt;
    ...
    public void cekJawaban(View v){
		String  jawabanBenar = "ANJING TETANGGA";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),BiasaActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.anjing, menu);
		return true;
	}
